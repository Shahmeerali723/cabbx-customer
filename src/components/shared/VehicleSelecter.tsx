...
const vehicles:any = {
  Cab: [
    ...
    { name: 'Cadiwweellac', image: 'https://static.toiimg.com/photo/80387978.cms' },
    { name: 'Cadillac', image: 'https://static.toiimg.com/photo/80387978.cms' },
    { name: 'Cadwwwwillac', image: 'https://static.toiimg.com/photo/80387978.cms' },
    { name: 'Cadillac', image: 'https://static.toiimg.com/photo/80387978.cms' },
      ...
      {vehicles[selectedTab].map((vehicle:any, index:any) => (
        <div key={index} className="flex-shrink-0">
          <img
            src={vehicle.image}
            alt={vehicle.name}
            className={`w-32 h-20 cursor-pointer ${selectedVehicle?.name === vehicle.name ? 'border-4 border-yellow-500' : ''}`}
